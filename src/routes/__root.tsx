...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lucky Draw — Monthly Lottery" },
      { name: "description", content: "A beautiful 20-member monthly lottery with a spinning wheel, live winners, and WhatsApp sharing." },
